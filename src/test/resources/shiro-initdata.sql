...
insert into sys_resource values(11, '商品管理', 'menu', '/goods', 1, '0/1/', 'goods:*', true);
insert into sys_resource values(12, '商品新增', 'button', '', 11, '0/1/11/', 'goods:create', true);
insert into sys_resource values(13, '商品修改', 'button', '', 11, '0/1/11/', 'goods:update', true);
insert into sys_resource values(14, '商品删除', 'button', '', 11, '0/1/11/', 'goods:delete', true);
insert into sys_resource values(15, '商品查看', 'button', '', 11, '0/1/11/', 'goods:view', true);
