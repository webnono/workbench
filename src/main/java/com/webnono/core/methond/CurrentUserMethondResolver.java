package com.webnono.core.methond;
 ...
 */
public class CurrentUserMethondResolver implements HandlerMethodArgumentResolver {

    public CurrentUserMethondResolver(){}
    @Override
    public boolean supportsParameter(MethodParameter methodParameter) {
        if (methodParameter.hasParameterAnnotation(CurrentUser.class))return true;
        return false;
    }
