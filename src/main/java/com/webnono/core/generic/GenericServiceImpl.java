package com.webnono.core.generic;
...
//    @Override
//    public Page<Model> selectList(Page page,Map<String, Object> param) {
//        System.out.println(page.getLimit());
//        List<Model> goodsList = getDao().selectList(page,param);
//        Page pageData = new Page(goodsList,page.getPageNo(),page.getPageSize());
//        return pageData;
//
//    }
}
