...
<div class="pub-box login-box">
  ...
  <form:form class="login-form" action="/goods/update" method="post" commandName="goods">
    <div class="cell">
      <form:input type="hidden" id="goods_id" path="goodsId" class="text" placeholder="商品淘宝链接" style="width:100%" />
    </div>
    <div class="cell">
    ...
    <div class="cell">
      <input type="submit" value="确认修改" class="button btn-e90"/>
    </div>
  </form:form>
</div>
